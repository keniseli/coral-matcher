...
def get_args():
    ...
    parser.add_argument("--input_size", type=int, default=512, nargs="+")
    parser.add_argument("--auto_stride", action="store_true", help="set stride size = patch size.")
    parser.add_argument("--stride_size", type=int, default=16, help="Stride size for the model.")
...
def main(args: argparse.Namespace):
    ...
    pos_w=32
    args.feat_dim = 768
    args.noise_map_height = 32
    args.noise_map_width = 32
